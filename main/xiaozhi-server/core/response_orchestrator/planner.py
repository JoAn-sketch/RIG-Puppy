...
def build_response_plan_prompt_patch(plan: ResponsePlan) -> str:
    lines = [
        ...
        f"response_length={plan.response_length}",
        f"should_follow_up={str(plan.should_follow_up).lower()}",
        f"should_close={str(plan.should_close).lower()}",
        f"scene_policy={plan.scene_policy}",
        f"memory_policy={plan.memory_policy}",
        f"tool_policy={plan.tool_policy}",
        f"safety_policy={plan.safety_policy}",
        f"lifecycle_state={plan.lifecycle_state}",
