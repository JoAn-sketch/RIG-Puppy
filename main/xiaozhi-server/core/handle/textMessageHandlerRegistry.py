...
from core.handle.textHandler.adoptionGreetingMessageHandler import AdoptionGreetingMessageHandler
...
from core.handle.textHandler.systemCueMessageHandler import SystemCueTextMessageHandler
...
class TextMessageHandlerRegistry:
    ...
    def _register_default_handlers(self) -> None:
        ...
        handlers = [
            ...
            PingMessageHandler(),
            SystemCueTextMessageHandler(),
            AdoptionGreetingMessageHandler(),
        ]
