...
const routes = [
  ...
  },
  {
    ...
    name: 'AgentModes',
    component: function () {
      return import('../views/AgentModes.vue')
    }
  }
]
...
// 需要登录才能访问的路由
const protectedRoutes = ['home', 'RoleConfig', 'AgentModes', 'DeviceManagement', 'UserManagement', 'ModelConfig', 'KnowledgeBaseManagement', 'KnowledgeFileUpload']
