...
export default {
    ...
    // ========== 对话模式 ==========
    getModeList(agentId, callback) {
        RequestService.sendRequest()
            .url(`${getServiceUrl()}/agent/${agentId}/modes`)
            .method('GET')
            .success((res) => { RequestService.clearRequestTime(); callback(res); })
            .networkFail(() => { RequestService.reAjaxFun(() => { this.getModeList(agentId, callback); }); })
            .send();
    },
    saveMode(agentId, data, callback) {
        RequestService.sendRequest()
            .url(`${getServiceUrl()}/agent/${agentId}/modes`)
            .method('POST')
            .data(data)
            .success((res) => { RequestService.clearRequestTime(); callback(res); })
            .networkFail(() => { RequestService.reAjaxFun(() => { this.saveMode(agentId, data, callback); }); })
            .send();
    },
    updateMode(agentId, modeId, data, callback) {
        RequestService.sendRequest()
            .url(`${getServiceUrl()}/agent/${agentId}/modes/${modeId}`)
            .method('PUT')
            .data(data)
            .success((res) => { RequestService.clearRequestTime(); callback(res); })
            .networkFail(() => { RequestService.reAjaxFun(() => { this.updateMode(agentId, modeId, data, callback); }); })
            .send();
    },
    deleteMode(agentId, modeId, callback) {
        RequestService.sendRequest()
            .url(`${getServiceUrl()}/agent/${agentId}/modes/${modeId}`)
            .method('DELETE')
            .success((res) => { RequestService.clearRequestTime(); callback(res); })
            .networkFail(() => { RequestService.reAjaxFun(() => { this.deleteMode(agentId, modeId, callback); }); })
            .send();
    },
    setDefaultMode(agentId, modeId, callback) {
        RequestService.sendRequest()
            .url(`${getServiceUrl()}/agent/${agentId}/modes/${modeId}/default`)
            .method('PUT')
            .success((res) => { RequestService.clearRequestTime(); callback(res); })
            .networkFail(() => { RequestService.reAjaxFun(() => { this.setDefaultMode(agentId, modeId, callback); }); })
            .send();
    },
