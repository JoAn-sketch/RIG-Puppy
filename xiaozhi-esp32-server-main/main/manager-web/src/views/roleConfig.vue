              ...
              <div class="form-content">
                <div class="form-grid">
                  <div class="form-column">
                    ...
                    <el-form-item>
                      <div style="text-align:right;margin-bottom:4px">
                        <el-button size="mini" type="text" icon="el-icon-setting" @click="$router.push({path:'/agent-modes',query:{agentId:$route.query.agentId}})">对话模式配置</el-button>
                      </div>
                      <template #label>
                  ...
                  <div class="form-column">
                    ...
                    <el-form-item label="摄像头工具">
                      <el-switch
                        v-model="form.enableCamera"
                        :active-value="1"
                        :inactive-value="0"
                        active-text="开启"
                        inactive-text="关闭"
                      />
                      <span style="margin-left: 8px; color: #909399; font-size: 12px;">关闭后 AI 不会主动拍照</span>
                    </el-form-item>
                  </div>
                </div>
              </div>
  ...
  methods: {
    ...
    async saveConfig() {
      ...
      const configData = {
        ...
        sort: this.form.sort,
        enableCamera: this.form.enableCamera,
    ...
    fetchAgentConfig(agentId) {
      Api.agent.getDeviceConfig(agentId, ({ data }) => {
        if (data.code === 0) {
          ...
          // 同步TTS设置到ttsSettings
          this.form.enableCamera = data.data.enableCamera ?? 0;
          this.ttsSettings = {
